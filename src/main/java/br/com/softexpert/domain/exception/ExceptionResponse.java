...
public class ExceptionResponse {
	...
	@ApiModelProperty(position = 1, example = "Requisição invalida", notes = "Descrição do erro", allowEmptyValue = false, required = true)
	...
	@ApiModelProperty(position = 3, notes = "Lista contendo a descricao de todas as validações da requisição", allowEmptyValue = false, required = true)
	@Builder.Default

...
public class SwaggerConfig {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.build()
				.apiInfo(apiInfo())
				.tags(new Tag(TAG_CALCULADORA, "Operação para calcular o total que cada um dos seus amigos deverão lhe pagar quando dividirem um pedido pelo iFood/UberEats"));
	}
